...
echo "5. Convert Signed Certificates"
    ...
    echo "     • PVWA: PFX files (optional password protection)"
    echo "     • PSM: PFX files (optional password protection)"
echo "     • HTML5GW: PFX files (optional password protection) + separate Base64 files"
    echo "     • PTA: PFX files (optional password protection) + Base64 key/cert files"
    echo "     • Vault: PFX files (password protection required)"
    echo ""
    echo -e "${YELLOW}Important Notes:${NC}"
    echo "- If password protection is enabled, a random password is generated and saved next to the PFX in a -password.txt file (chmod 600)"
    ...
    echo "- PVWA: PFX file (password optional)"
    echo "- PSM: PFX file (password optional)"
    echo "- HTML5GW: PFX file (password optional) + separate key/cert files"
echo "- PTA: PFX file (password optional) + Base64 key/cert files"
    echo "- Vault: PFX file (password required)"
    echo ""
